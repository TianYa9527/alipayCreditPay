package com.greatwall.jhgx.util.multibody;
...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private static final String EXCEPTION_MSG_FORMAT = "required param %s is not present";
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        if(null == parameterAnnotation){
            throw new IllegalArgumentException("参数解析为空");
        }
        //注解的value是JSON的key
        ...
        if (StringUtils.isNotEmpty(key)) {
            ...
            if (value == null && parameterAnnotation.required()) {
                throw new IllegalArgumentException(String.format(EXCEPTION_MSG_FORMAT, key));
            }
        } else {
        ...
        try {
            ...
            log.error("jsonObject解析失败", jsonException);
            result = null;
        }
        return result;
    }
